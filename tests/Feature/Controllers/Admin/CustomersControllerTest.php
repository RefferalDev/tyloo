...
class CustomersControllerTest extends TestCase
{
    ...
    public function it_can_upload_an_image_for_customer()
    {
        ...
        $this->get('/admin/customers/create')->type('Acme', 'label')->type('May the Force be with you... Always.', 'description')->attach($absolutePathToFile, 'image')->press('Submit');
    ...
    public function it_can_create_a_customer()
    {
        ...
        $this->get('/admin/customers/create');
    }
