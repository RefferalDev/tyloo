...
@section('content')
    @include('partials.common.header._headerPage', ['pageName' => trans('app.frontend.resume.page-title'), 'pageNameBreadcrumb' => trans('app.frontend.resume.breadcrumb-title')])
