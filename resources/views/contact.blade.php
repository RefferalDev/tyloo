...
@section('content')
    @include('partials.common.header._headerPage', ['pageName' => trans('app.frontend.contact.page-title'), 'pageNameBreadcrumb' => trans('app.frontend.contact.breadcrumb-title')])
