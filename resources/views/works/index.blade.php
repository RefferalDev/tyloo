...
@section('content')
    @include('partials.common.header._headerPage', ['pageName' => trans('app.frontend.works.index.page-title'), 'pageNameBreadcrumb' => trans('app.frontend.works.index.breadcrumb-title')])
